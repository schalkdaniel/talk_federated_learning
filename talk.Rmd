...
1.  Each client calculates a small update given its dataset
...
-   **Non-IID:** The training data on a given client is typically based on external influences, hence any client's local dataset will not be representative of the population distribution.
...
We use Gradient Descent as optimization algorithm. This can be used e.g. to train linear models, general linear models, or neural networks.
...
Instead of making one huge update on the host side, the update is conducted on the client side and aggregate the updates:
$$
...
$$
Additionally, it is possible to use different methods to aggregate the reported updates:
$$
...
With the Federated Averaging algorithm we can consider reducing communication costs. Therefore, we conduct $E$ updates in $\mathsf{clientUpdate}$:
...
\includegraphics[width=\textwidth]{images/fed_logreg_iid_01_10.pdf}

## Visualization - Setup 1

\includegraphics[width=\textwidth]{images/fed_logreg_iid_01_1000.pdf}

## Visualization - Setup 2

\includegraphics[width=\textwidth]{images/fed_logreg_non_iid_01_10.pdf}

## Visualization - Setup 2

\includegraphics[width=\textwidth]{images/fed_logreg_non_iid_01_1000.pdf}

<!-- ## Visualization - Setup 3 -->

<!-- \includegraphics[width=\textwidth]{images/fed_logreg_iid_ub_01_10.pdf} -->

<!-- ## Visualization - Setup 4 -->

<!-- \includegraphics[width=\textwidth]{images/fed_logreg_non_iid_ub_01_10.pdf} -->

<!-- ## Visualization - Setup 4 -->

<!-- \includegraphics[width=\textwidth]{images/fed_logreg_non_iid_ub_01_1000.pdf} -->
